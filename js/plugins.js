...
if ( window.jQuery || window.Zepto ) {
  (function($) {
	...
	window.granteeProfiles = $('#grantee-profiles').Swipe().data('Swipe');
	window.accNum = $('#accomplishments-numbers').Swipe().data('Swipe');
	
	// Accomplishment Nav
    var $accNav = $('#accomplishments-nav li');
    $accNav.on ('click', function () {
        window.accNum.slide($(this).index() + 0, 200);
	...
	// Grantee Profile Nav
    var $granteeNav = $('#grantee-nav li');
    $granteeNav.on ('click', function () {
        window.granteeProfiles.slide($(this).index() + 0, 200);
   ...
   $('#granteePrev').on('click', function () {
       granteeProfiles.prev();
       
       $granteeNav.removeClass('selected');
       $granteeNav.eq(granteeProfiles.getPos() - 0).addClass('selected');
   });
   $('#granteeNext').on('click', function () {
       granteeProfiles.next();
       $granteeNav.removeClass('selected');
       $granteeNav.eq(granteeProfiles.getPos() - 0).addClass('selected');
   });   
